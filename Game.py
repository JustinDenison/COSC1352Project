...
class Game(Frame):
    ...
    def createRooms(self):
        ...
        r19 = Room("Room 19", "room19.gif")
        r20 = Room("Room 20", "room20.gif")
        r21 = Room("Room 21", "room21.gif")
        r22 = Room("Room 22", "room22.gif")
        r23 = Room("Room 23", "room23.gif")
        r24 = Room("Room 24", "room24.gif")
        r1.addExit("north", r2)
        r2.addExit("north" , r3)
        r3.addExit("north" , r4)
        r3.addExit("east", r17)
